...
export function PiFolderAiDuoStroke(props: JSX.IntrinsicElements["svg"]) {
  return (
    <svg
      aria-hidden="true"
      {...props}
    ...
    >
      ...
      />
      <path
        d="M8.5 17.5H8.501M12.5 10.5C11.8625 12.1165 11.1609 12.845 9.5 13.5C11.1609 14.155 11.8625 14.8835 12.5 16.5C13.1375 14.8835 13.8391 14.155 15.5 13.5C13.8391 12.845 13.1375 12.1165 12.5 10.5Z"
        stroke="currentcolor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="2"
