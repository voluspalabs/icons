...
export function PiPiechartRoseContrast(props: JSX.IntrinsicElements["svg"]) {
  return (
    <svg
      aria-hidden="true"
      {...props}
    ...
    >
      <path
        d="M10.9949 2.86377C16.5934 2.86377 21.1319 7.40227 21.1319 13.0008H19.8578C19.8578 17.8957 15.8898 21.8638 10.9949 21.8638V20.7559C6.71187 20.7559 3.23975 17.2838 3.23975 13.0008H4.34767C4.34767 9.32963 7.32373 6.35357 10.9949 6.35357V2.86377Z"
        fill="currentcolor"
        opacity="0.28"
      />
      <path
